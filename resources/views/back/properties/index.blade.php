...
@section('button')
    <a href="{{ route('properties.create') }}" class="btn btn-primary">@lang('New Property')</a>
@endsection
                    ...
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @if (session('property-ok'))
                                ...
                                @endcomponent
                            @endif
                            @include('back.properties.table', compact('properties'))
                        </tbody>
                    </table>
                </div>
                <!-- /.box-body -->
...
@section('js')
    ...
    <script>
        ...
        var property = (function () {
            ...
            var swalTitle = '@lang('Really destroy property ?')'
        ...
        $(document).ready(property.onReady)

               ...
               <table id="info_currency" class="info_currency_table" cellspacing="0">
                   ...
                   <tbody>
                       <tr>
                           ...
                           <td class="currency_values"><img src="/images/{!!($currencyFrom->type === "currency" ? '':'tokens/').$currencyFrom->image!!}"/>  {{number_format($basicDetails ? $basicDetails->last_value : 0, 8, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td class="usd_values">U$D {{number_format(($basicDetails ? $basicDetails->last_value : 0) * $currencyFrom->usd_value, 2, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td rowspan="2" class="key_values">Volumen</td>
                           <td class="currency_values"><img src="/images/{!!($currencyFrom->type === "currency" ? '':'tokens/').$currencyFrom->image!!}"/>  {{number_format($basicDetails ? $basicDetails->volume : 0, 4, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td class="usd_values">U$D {{number_format(($basicDetails ? $basicDetails->volume : 0) * $currencyFrom->usd_value, 2, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td rowspan="2" class="key_values">Venta</td>
                           <td class="currency_values"><img src="/images/{!!($currencyFrom->type === "currency" ? '':'tokens/').$currencyFrom->image!!}"/>  {{number_format($basicDetails ? $basicDetails->ask  : 0, 8, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td class="usd_values">U$D {{number_format(($basicDetails ? $basicDetails->ask : 0) * $currencyFrom->usd_value, 2, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td rowspan="2" class="key_values">Compra</td>
                           <td class="currency_values"><img src="/images/{!!($currencyFrom->type === "currency" ? '':'tokens/').$currencyFrom->image!!}"/>  {{number_format($basicDetails ? $basicDetails->bid : 0, 8, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td class="usd_values">U$D {{number_format(($basicDetails ? $basicDetails->bid : 0) * $currencyFrom->usd_value, 2, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td rowspan="2" class="key_values">24H Máximo</td>
                           <td class="currency_values"><img src="/images/{!!($currencyFrom->type === "currency" ? '':'tokens/').$currencyFrom->image!!}"/>  {{number_format($basicDetails ? $basicDetails->high : 0, 8, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td class="usd_values">U$D {{number_format(($basicDetails ? $basicDetails->high : 0) * $currencyFrom->usd_value, 2, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td rowspan="2" class="key_values">24H Mínimo</td>
                           <td class="currency_values"><img src="/images/{!!($currencyFrom->type === "currency" ? '':'tokens/').$currencyFrom->image!!}"/>  {{number_format($basicDetails ? $basicDetails->low : 0, 8, ".", "")}}</td>
                       </tr>
                       <tr>
                           <td class="usd_values">U$D {{number_format(($basicDetails ? $basicDetails->low : 0) * $currencyFrom->usd_value, 2, ".", "")}}</td>
                       </tr>
                   </tbody>
               </table>
           </div>

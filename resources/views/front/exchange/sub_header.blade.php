<div1 class="currency_wrapper" onclick="location.href='{{ url("exchangeDetails?pair=CTK-".$currency->alias) }}'">
    <div class="left-details">
        <a class="vcenter" href="{{ url("exchangeDetails?pair=CTK-".$currency->alias) }}">
    ...
    <div class="right-details">
        ...
        <div class ="sub_header_volume">{!! number_format($currency->volume, 4, ".", "")." CTK" !!}</div>
